...
### Changed
- feat(router): sort models in one canonical cross-provider order
- release: update version files for v0.7.179, bump to next dev version


## [v0.7.179] - 2026-09-25

### Changed
- feat(core): expose provider catalog, token and pricing API
- release: update version files for v0.7.178, bump to next dev version


## [v0.7.178] - 2026-09-25

### Changed
- fix(llm): update Claude Code OAuth user agent
- release: update version files for v0.7.177, bump to next dev version


## [v0.7.177] - 2026-09-22

### Changed
- fix(context): unify provider metadata and input budgets
- release: update version files for v0.7.176, bump to next dev version


## [v0.7.176] - 2026-09-22

### Changed
- feat(router): add GPT-6 Sol and Luna model support
- release: update version files for v0.7.175, bump to next dev version
...
### Changed
- feat(router): curate GLM-5.3-FlashX on every z.ai surface
- release: update version files for v0.7.172, bump to next dev version


## [v0.7.172] - 2026-09-17

### Changed
- refactor(copilot): one github-copilot provider, no plan-tier ids
- release: update version files for v0.7.171, bump to next dev version


## [v0.7.171] - 2026-09-15

### Changed
- fix(tokens): count quoted special tokens instead of throwing
- release: update version files for v0.7.170, bump to next dev version
...
### Changed
- fix(tokens): expose request accounting (Blockether/vis#186)
- release: update version files for v0.7.166, bump to next dev version
...
### Changed
- fix(responses): consume streamed output items once
- release: update version files for v0.7.163, bump to next dev version
...
### Changed
- fix(llm): replay a prewarmed inference whose continuation never starts
- release: update version files for v0.7.159, bump to next dev version
...
### Changed
- fix(router): fall back after provider quota exhaustion
- release: update version files for v0.7.155, bump to next dev version
...
### Changed
- fix(llm): bump Claude Code OAuth user agent
- release: update version files for v0.7.151, bump to next dev version


## [v0.7.151] - 2026-09-03

### Changed
- feat(router): add Claude Fable 5.1 support
- release: update version files for v0.7.150, bump to next dev version
...
### Changed
- fix(llm): strip Codex Priority from Anthropic requests
- release: update version files for v0.7.148, bump to next dev version
...
### Changed
- feat(cache): expose prompt cache context identity
- chore(models): store the models.dev snapshot pretty-printed
- release: update version files for v0.7.146, bump to next dev version


## [v0.7.146] - 2026-08-26

### Changed
- feat(router): add z.ai GLM-5.3-Flash
- release: update version files for v0.7.145, bump to next dev version
...
### Changed
- fix(network): propagate first-byte timeout through asks
- release: update version files for v0.7.141, bump to next dev version
...
### Changed
- fix(llm): restart safe stalls before provider fallback
- release: update version files for v0.7.139, bump to next dev version
...
### Changed
- fix(llm): watch model progress on the websocket transport too
- release: update version files for v0.7.137, bump to next dev version


## [v0.7.137] - 2026-08-24

### Changed
- fix(llm): keep reasoning boundaries on the websocket path
- release: update version files for v0.7.136, bump to next dev version


## [v0.7.136] - 2026-08-24

### Changed
- fix(llm): recover streams without model progress
- release: update version files for v0.7.135, bump to next dev version


## [v0.7.135] - 2026-08-23

### Changed
- fix(llm): give routed transients one retry owner
- release: update version files for v0.7.134, bump to next dev version


## [v0.7.134] - 2026-08-23

### Changed
- fix(llm): retry nested Responses server errors
- release: update version files for v0.7.133, bump to next dev version


## [v0.7.133] - 2026-08-22

### Changed
- fix(llm): preserve sockets across history resets
- release: update version files for v0.7.132, bump to next dev version
...
### Changed
- chore(format): adopt shared zprint rules, drop clojure-lsp
- release: update version files for v0.7.130, bump to next dev version
...
### Changed
- fix(llm): stop sending cache breakpoints Codex refuses
- release: update version files for v0.7.128, bump to next dev version
...
### Changed
- fix(gateway): always strip strict tool fields
- release: update version files for v0.7.124, bump to next dev version


## [v0.7.124] - 2026-08-19

### Changed
- fix(llm): collapse Responses composite tool ids on the chat wire
- release: update version files for v0.7.123, bump to next dev version
...
### Changed
- fix(router): decide vision per provider, not per model name
- release: update version files for v0.7.119, bump to next dev version


## [v0.7.119] - 2026-08-17

### Changed
- feat(router): make :capabilities a routing filter callers can require
- feat(router): curate glm-5v-turbo on the z.ai coding plan
- release: update version files for v0.7.118, bump to next dev version
...
- `:reasoning-effort` accepts the exact rung `"low"` alongside `"high"` and `"max"`, still catalog-gated per model, so GLM-5.3's light rung is reachable from the exact provider-native API too.

## [v0.7.116] - 2026-08-14

### Changed
- Record why a provider failure was not retried
- release: update version files for v0.7.115, bump to next dev version
...
### Changed
- Honor a provider's declared retry cooldown
- release: update version files for v0.7.105, bump to next dev version


## [v0.7.105] - 2026-08-07

### Changed
- Canonicalize the mid-stream overload retry ladder
- Deepen and announce the same-provider overload retry ladder
- release: update version files for v0.7.104, bump to next dev version


## [v0.7.104] - 2026-08-06

### Changed
- Classify exhausted provider attempts
- release: update version files for v0.7.103, bump to next dev version


## [v0.7.103] - 2026-08-06

### Changed
- Treat Anthropic extra-usage exhaustion as terminal
- release: update version files for v0.7.102, bump to next dev version


## [v0.7.102] - 2026-08-06

### Changed
- Add GPT-5.6 Luna to OpenAI Codex
- Format router alignment and tidy AGENTS guidance
- release: update version files for v0.7.101, bump to next dev version
- release: update version files for v0.7.100, bump to next dev version
...
### Changed
- Send per-tool strict sampling to Anthropic and the OpenAI wires
- release: update version files for v0.7.99, bump to next dev version


## [v0.7.99] - 2026-08-03

### Changed
- Parse provider responses as data, never interning wire keys
- release: update version files for v0.7.98, bump to next dev version


## [v0.7.98] - 2026-08-03

### Changed
- Never intern model tool arguments in provider responses
- release: update version files for v0.7.97, bump to next dev version
...
[v0.7.14]: https://github.com/Blockether/svar/releases/tag/v0.7.14
[v0.7.15]: https://github.com/Blockether/svar/releases/tag/v0.7.15
[v0.7.16]: https://github.com/Blockether/svar/releases/tag/v0.7.16
...
[v0.7.26]: https://github.com/Blockether/svar/releases/tag/v0.7.26
[v0.7.27]: https://github.com/Blockether/svar/releases/tag/v0.7.27
...
[v0.7.45]: https://github.com/Blockether/svar/releases/tag/v0.7.45
...
[v0.7.65]: https://github.com/Blockether/svar/releases/tag/v0.7.65
...
[v0.7.74]: https://github.com/Blockether/svar/releases/tag/v0.7.74
...
[v0.7.80]: https://github.com/Blockether/svar/releases/tag/v0.7.80
...
[v0.7.98]: https://github.com/Blockether/svar/releases/tag/v0.7.98
[v0.7.99]: https://github.com/Blockether/svar/releases/tag/v0.7.99
[v0.7.100]: https://github.com/Blockether/svar/releases/tag/v0.7.100
[v0.7.101]: https://github.com/Blockether/svar/releases/tag/v0.7.101
[v0.7.102]: https://github.com/Blockether/svar/releases/tag/v0.7.102
[v0.7.103]: https://github.com/Blockether/svar/releases/tag/v0.7.103
[v0.7.104]: https://github.com/Blockether/svar/releases/tag/v0.7.104
...
[v0.7.133]: https://github.com/Blockether/svar/releases/tag/v0.7.133
[v0.7.134]: https://github.com/Blockether/svar/releases/tag/v0.7.134
[v0.7.135]: https://github.com/Blockether/svar/releases/tag/v0.7.135
...
[v0.7.176]: https://github.com/Blockether/svar/releases/tag/v0.7.176
[v0.7.177]: https://github.com/Blockether/svar/releases/tag/v0.7.177
