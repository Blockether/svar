...
(def version
  (let [v (System/getenv "VERSION")]
    (if (and v (.startsWith v "v")) (subs v 1) (or v "0.0.1-SNAPSHOT"))))
...
(defn compile-java
  [_]
  (b/javac
    {:src-dirs ["src/java"] :class-dir class-dir :basis @basis :javac-opts ["--release" "11"]}))
...
(defn jar
  ...
  (b/write-pom
    {:class-dir class-dir
     ...
     :pom-data
     [[:description
       "svar — answer in Swedish. Type-safe LLM output for Clojure, inspired by BAML. Schemaless JSON parsing, token counting, guardrails, and agentic reasoning loops."]
      [:url "https://github.com/Blockether/svar"]
      [:licenses
       [:license [:name "Apache License, Version 2.0"]
        [:url "https://www.apache.org/licenses/LICENSE-2.0"]]]]})
  (b/copy-dir {:src-dirs ["src/clj" "src/java" "resources"] :target-dir class-dir})
